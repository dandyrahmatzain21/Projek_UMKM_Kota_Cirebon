...
class KategoriController extends Controller
{
    ...
    public function insert()
    {
        ...
        return redirect()->route('kategori',$id_penjual)->with('Pesan','Data Berhasil Di tambahkan');
    }
    //
    ...
    public function update($id_kategori)
    {
        ...
        return redirect()->route('kategori',$id_penjual)->with('Pesan','Data Berhasil Di Update');
    }
    //
