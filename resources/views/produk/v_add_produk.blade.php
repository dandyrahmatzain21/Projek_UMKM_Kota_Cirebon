...
@section('konten')
    <form method="POST" action="/produk/insert" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <input type="hidden" name="id_produk" class="form-control @error('id_produk') is-invalid @enderror" id="id_produk" placeholder="Id produk" value="<?php echo substr(str_shuffle($id_random), 0, 6);?>" readonly>
        ...
        <!-- Field id produk -->
        <div class="form-group">
            <input type="hidden" name="id_penjual" class="form-control @error('id_penjual') is-invalid @enderror" id="id_penjual" placeholder="Id Penjual" value="{{auth()->user()->id}}" readonly>
            <div class="invalid-feedback">
                @error('id_penjual')
                    {{ $message}}
                @enderror
        ...
        <div class="form-group">
            ...
            <input type="number" name="berat" class="form-control @error('berat') is-invalid @enderror" id="berat" placeholder="Berat" value="{{old('berat')}}">
            <div class="invalid-feedback">
                @error('berat')
                    {{ $message}}
                @enderror
    ...
    <div class="modal-footer">
        <a href="/produk" class="btn btn-danger" class="btn btn-icon btn-danger" type="button">
